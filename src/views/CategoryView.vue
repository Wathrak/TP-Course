<template>
  <div class="h-[235px] bg-[#d6fae9] flex m-[50px] rounded-2xl">
    <img src="@/assets/images/cool-bg1.png" alt="pic" class="absolute" />
    <img
      src="@/assets/images/cool-bg2.png"
      alt="pic"
      class="absolute left-[600px]"
    />
