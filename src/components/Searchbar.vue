<template>
    <div class="flex justify-between items-center self-center py-4">
        ...
        <div
            ...
            <button class="mx-1">All Categories</button>
            <div class="mx-4 text-gray-400">|</div>
            <input type="search" name="searchbar" id="searchbar" placeholder="Search for items"
                class=" placeholder:text-gray-300">
            <i class="fa-solid fa-magnifying-glass mt-2 ml-48" style="color: #6b7280;"></i>
        </div>
